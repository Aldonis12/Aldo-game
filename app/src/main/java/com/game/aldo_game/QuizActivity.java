...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //int quest = random.nextInt(questionsLists.size());
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedOptionByUser.isEmpty()){
                    Toast.makeText(QuizActivity.this,"Misafidiana eh", Toast.LENGTH_SHORT).show();
                }
                else{
                    changeNextQuestion();
                }
        ...
        /*backBtn.setOnclickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(QuizActivity.this, PasssageActivity.class));
                finish();
            }
        }); */


        info = (ImageView) findViewById(R.id.infoQuiz);
        info.setOnClickListener(new View.OnClickListener() {
            ...
            private void openDialog() {
                ExempleDialog_quiz exempleDialog = new ExempleDialog_quiz();
    ...
    private void changeNextQuestion(){
        ...
        if ((currentQuestionPosition) < questionsLists.size()){
            ...
            option1.setBackgroundResource(R.drawable.round_back2);
            option1.setTextColor(Color.parseColor("#1F6BB8"));

            option2.setBackgroundResource(R.drawable.round_back2);
            option2.setTextColor(Color.parseColor("#1F6BB8"));

            option3.setBackgroundResource(R.drawable.round_back2);
            option3.setTextColor(Color.parseColor("#1F6BB8"));

            option4.setBackgroundResource(R.drawable.round_back2);
    ...
    private void startTimer(TextView timerTextView){
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                /*if (seconds == 5){
                    Looper.prepare();
                    final Toast toast = Toast.makeText(QuizActivity.this,"5 second sisa tavela",Toast.LENGTH_SHORT);
                    toast.show();
                    Looper.loop();
                    }*/
                else if(seconds == 1){
